...
public class Fishing : MonoBehaviour
{
    ...
    IDictionary<int, Fish> indexToFishDict = new Dictionary<int, Fish>() {
        ...
        {2, new Fish(2,"Largemouth Bass",270,2,.25f,.6f,3)},
        {3, new Fish(3,"Lake Trout",300,3,.1f,.5f,4)},
        {4, new Fish(4,"White Bass",350,3,.1f,.45f,5)},
        {5, new Fish(5,"Carp",270,4,.27f,.7f,7)},
        {6, new Fish(6,"Yellow Carp",300,4,.30f,.7f,8)},
        {7, new Fish(7,"WhiteFish",325,4,.15f,.60f,10)},
        {8, new Fish(8,"Steelhead Trout",350,4,.15f,.70f,12)},
        {9, new Fish(9,"Sunfish",375,5,.2f,.70f,50)},
        {10, new Fish(10,"Walleye",375,6,.2f,.70f,120)},
        {11, new Fish(11,"Northern Pike",375,7,.2f,.6f,100)},
        {12, new Fish(12,"Muskelunge",400,10,.2f,.8f,150)},
        {13, new Fish(13,"Crappie",400,10,.3f,.9f,200)},
        {14, new Fish(14,"Brook Trout",350,10,.15f,.25f,300)},
        {15, new Fish(15,"Coho Salmon",600,12,.25f,.5f,400)},
